...
public class UILayout : MonoBehaviour {
	...
	void Start () {
		instance = this;
		orginalPos = bottom.localPosition;
//		TopIn();
//		BottomIn();
	}
...
//		tpTop.method = UITweener.Method.BounceOut;
	...
	{
		TweenPosition tpBottom = TweenPosition.Begin(bottom.gameObject, 0.5f, orginalPos);//bottom.localPosition + new Vector3(0, 260, 0));
	...
	{
		TweenPosition tpBottom = TweenPosition.Begin(bottom.gameObject, 0.5f, bottom.localPosition + new Vector3(0, -300, 0));
		tpBottom.from = bottom.localPosition;
