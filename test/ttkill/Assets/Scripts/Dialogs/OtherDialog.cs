...
public class OtherDialog : DialogBase {
	...
	void Start()
	{
		...
		{
			btnGoldDouble.gameObject.collider.enabled = false;
			btnGoldDouble.spriteName = disableSpriteName;
		}
		else
		{
			btnGoldDouble.gameObject.collider.enabled = true;
		...
		if (SettingManager.Instance.DiamondJiacheng != 1 && btnGoldDouble != null)
		{
			...
			{
				btnDiamondAdditional.gameObject.collider.enabled = false;
				btnDiamondAdditional.spriteName = disableSpriteName;
			}
			else
			{
				btnDiamondAdditional.gameObject.collider.enabled = true;
		...
		{
			btnBulletCapacity.gameObject.collider.enabled = false;
			btnBulletCapacity.spriteName = disableSpriteName;
		}
		else
		{
			btnBulletCapacity.gameObject.collider.enabled = true;
