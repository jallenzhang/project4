...
public class SettingManager  {
	...
	private string CURRENTAVATAR = "CURRENTAVATAR"; //1:nan 2:nv
	...
	public int CurrentAvatar
	{
		get
		{
			return PlayerPrefs.HasKey(CURRENTAVATAR)?PlayerPrefs.GetInt(CURRENTAVATAR):1;
		}
		set
		{
			PlayerPrefs.SetInt(CURRENTAVATAR, value);
			PlayerPrefs.Save();
		}
	}
	...
	public int TotalGold 
	{
		get
		{
			return PlayerPrefs.HasKey(GOLD)?PlayerPrefs.GetInt(GOLD):5000;
		}
		set
		{
