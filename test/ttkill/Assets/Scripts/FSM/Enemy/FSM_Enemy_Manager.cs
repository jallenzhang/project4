...
public class FSM_Enemy_Manager : MonoBehaviour {
	...
	private static FSM_Enemy_Manager instance = null;
	public static FSM_Enemy_Manager Instance
	{
		get
		{
//			if (instance == null)
...
//				n.name = "FSM_ENEMY";
//				instance = n.AddComponent<FSM_Enemy_Manager>() as FSM_Enemy_Manager;
//			}
