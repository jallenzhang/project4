...
public class WeaponStatus2 : MonoBehaviour {
	public UISprite icon;
	private int weaponMP = 400;
	private static WeaponStatus2 instance = null;

	public static WeaponStatus2 Instance
	{
		get
		{
			return instance;
	...
	public void OnWeaponChange(WeaponType type, int capactiy)
	{
